...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('GL_RunningDetention_Charges_Cont', {
    Id: {
      autoIncrement: true,
    ...
    sequelize,
    tableName: 'GL_RunningDetention_Charges_Cont',
    schema: 'dbo',
    timestamps: false,
    indexes: [
      {
        name: "PK_GL_RunningDetention_Charges_Cont",
        unique: true,
        fields: [
          { name: "Id" },
        ]
