...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('AImp_AirImportJob', {
    Id: {
      autoIncrement: true,
    ...
    JobNumber: {
      ...
      allowNull: true,
      unique: "IX_AImp_AirImportJob_JobNumber"
    },
    JobDate: {
      type: DataTypes.DATE,
      allowNull: true
    ...
    sequelize,
    tableName: 'AImp_AirImportJob',
    schema: 'dbo',
    timestamps: false,
    indexes: [
      {
        name: "IX_AImp_AirImportJob_JobNumber",
        unique: true,
        fields: [
          { name: "JobNumber" },
        ]
