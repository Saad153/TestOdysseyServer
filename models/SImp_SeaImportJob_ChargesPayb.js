...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('SImp_SeaImportJob_ChargesPayb', {
    Id: {
      autoIncrement: true,
    ...
    SecurityFilePayableId: {
      type: DataTypes.BIGINT,
      allowNull: true
    },
    SecurityFileDetentionId: {
      type: DataTypes.BIGINT,
      allowNull: true
    },
    DistributionId: {
    ...
    sequelize,
    tableName: 'SImp_SeaImportJob_ChargesPayb',
    schema: 'dbo',
    timestamps: false,
    indexes: [
      {
        name: "PK_SImp_SeaImportJob_ChargesPayb",
        unique: true,
        fields: [
          { name: "Id" },
        ]
