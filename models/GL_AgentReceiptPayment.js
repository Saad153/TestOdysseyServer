...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('GL_AgentReceiptPayment', {
    Id: {
      autoIncrement: true,
    ...
    TranNumber: {
      ...
      allowNull: true,
      unique: "IX_GL_AgentReceiptPayment_TranNumber"
    },
    TranDate: {
      type: DataTypes.DATE,
      allowNull: true
    ...
    sequelize,
    tableName: 'GL_AgentReceiptPayment',
    schema: 'dbo',
    timestamps: false,
    indexes: [
      {
        name: "IX_GL_AgentReceiptPayment_TranNumber",
        unique: true,
        fields: [
          { name: "TranNumber" },
        ]
      ...
      {
        name: "PK_GL_AgentReceiptPayment",
        unique: true,
        fields: [
          { name: "Id" },
        ]
